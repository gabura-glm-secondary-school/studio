          ...
          <div className="lg:col-span-3 space-y-8 animate-in fade-in slide-in-from-right duration-300">
            ...
            <div className="glass-card p-8 md:p-10 relative overflow-hidden">
              ...
              <div className="relative z-10 space-y-6 text-muted-foreground leading-relaxed text-lg font-medium">
                ...
                <p>
                  প্রতিষ্ঠানের সার্বিক ক্ষেত্রে সফলতার জন্য মানুষের মাঝে এক ধরনের চাহিদা সৃষ্টি হওয়ায় তাঁরা তাঁদের কোমলমতি ছেলে মেয়েদের এই প্রতিষ্ঠানে পড়াশুনা করাতে যথেষ্ট আগ্রহী হয়ে উঠেছেন। প্রতিষ্ঠানের সাফল্যে অভিভাকগণের মধ্যে ইতিবাচক প্রভাব ছাড়াও বিভিন্ন পর্যায়ে বেশ প্রসংশনীয় অবদান রাখছে।
                </p>
                <p>
