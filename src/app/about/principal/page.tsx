  ...
  return (
    <div className="pt-32 pb-24 min-h-screen bg-secondary/5">
      <div className="max-w-4xl mx-auto px-4 space-y-12">
        {/* Header navigation */}
        <Link href="/">
          <Button variant="ghost" className="gap-2 text-muted-foreground hover:text-primary mb-8 px-0">
        ...
        <div className="grid lg:grid-cols-5 gap-12 items-start">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="glass-card p-6 text-center space-y-2">
              <h2 className="text-xl font-headline font-black text-primary">মোঃ আশরাফুল আলম</h2>
              <p className="text-xs font-bold text-accent uppercase tracking-widest">অধ্যক্ষ</p>
