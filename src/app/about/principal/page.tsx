          ...
          <div className="lg:col-span-3 space-y-8 animate-in fade-in slide-in-from-right duration-500">
            ...
            <div className="glass-card p-8 md:p-10 relative overflow-hidden">
              ...
              <div className="relative z-10 space-y-6 text-muted-foreground leading-relaxed text-lg font-medium">
                ...
                <p>
                  ফলশ্রুতিতে বিদ্যালয় টি উপজেলা তথা জেলার প্রথম সারির প্রতিষ্ঠান হিসাবে স্বীকৃত। প্রতি বছর ট্যালেন্টপুল ও সাধারণ গ্রেডে বৃত্ত প্রাপ্তিসহ জে.এস.সি ও এস.এস.সি পরীক্ষায় গোল্বেন এ+ পেয়ে শতভাগ পাশের স্বাক্ষর রেখে আসছে।
                </p>
                <p>
