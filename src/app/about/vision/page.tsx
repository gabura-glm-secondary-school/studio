      ...
      <div className="max-w-5xl mx-auto px-4 space-y-16">
        <div className="space-y-4">
          ...
          <div className="text-center space-y-4">
            <span className="text-accent font-black uppercase tracking-[0.2em] text-[10px]">Future Roadmap</span>
            <h1 className="text-4xl lg:text-6xl font-headline font-black text-primary">ভিশন ও মিশন</h1>
          </div>
        </div>

        <div className="grid lg:grid-cols-2 gap-8">
          <Card className="glass-card border-l-8 border-l-primary !rounded-[3rem] p-10 space-y-6 hover-lift">
          ...
          <Card className="glass-card border-l-8 border-l-accent !rounded-[3rem] p-10 space-y-6 hover-lift">
        ...
        <div className="space-y-8">
          <h3 className="text-2xl font-headline font-black text-primary text-center">আমাদের মূল স্তম্ভসমূহ</h3>
          <div className="grid md:grid-cols-3 gap-6">
            {pillars.map((p, i) => (
              <div key={i} className="glass-card p-8 text-center space-y-4 hover:bg-white transition-all">
