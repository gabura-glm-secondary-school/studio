...
import { Users, GraduationCap, ChevronRight, Trophy } from "lucide-react";
    ...
    <div className="pt-48 pb-24 min-h-screen">
      <div className="max-w-7xl mx-auto px-4">
        ...
        {mockBatches.length === 0 ? (
          <div className="py-32 text-center space-y-6 bg-secondary/5 rounded-[4rem] border-2 border-dashed border-muted-foreground/20">
            <Trophy size={56} className="text-primary/20 mx-auto" />
            <p className="text-muted-foreground font-black uppercase tracking-[0.3em] text-sm">কোনো ব্যাচ তালিকাভুক্ত করা হয়নি</p>
          </div>
        ) : (
