...
export default function AdminDashboard() {
  const stats = [
    { label: "Total Students", val: "0", icon: GraduationCap, color: "text-blue-600", bg: "bg-blue-50" },
    { label: "Total Teachers", val: "0", icon: Briefcase, color: "text-emerald-600", bg: "bg-emerald-50" },
    { label: "Pending Approvals", val: "0", icon: UserCheck, color: "text-amber-600", bg: "bg-amber-50" },
    { label: "Security Alerts", val: "0", icon: ShieldAlert, color: "text-destructive", bg: "bg-destructive/5" },
  ];
    ...
    <div className="space-y-8 animate-in fade-in duration-500">
          ...
          <Card key={idx} className="border-none shadow-sm hover:shadow-md transition-shadow">
            <CardContent className="pt-6">
              ...
              <div className="mt-4 pt-4 border-t flex items-center text-[10px] font-bold text-muted-foreground gap-1">
                ...
                <span className="text-emerald-600">0%</span> from last month
              </div>
            </CardContent>
          </Card>
        ))}
          ...
          <CardContent className="h-[350px] pt-8">
            {attendanceData.length === 0 ? (
              <div className="h-full flex flex-col items-center justify-center gap-3 text-muted-foreground">
                ...
                <p className="text-xs font-black uppercase tracking-widest">কোনো ডেটা পাওয়া যায়নি।</p>
              </div>
            ) : (
        ...
        <Card className="border-none shadow-sm">
          ...
          <CardContent className="space-y-4">
            <div className="py-10 text-center space-y-2">
              <ShieldAlert size={32} className="mx-auto text-emerald-500/20" />
              <p className="text-[10px] font-black text-muted-foreground uppercase tracking-widest">সিস্টেম নিরাপদ আছে।</p>
            </div>
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        <Card className="border-none shadow-sm">
          ...
          <CardContent className="space-y-4">
            <div className="py-10 text-center space-y-2">
              <AlertTriangle size={32} className="mx-auto text-muted-foreground/10" />
              <p className="text-[10px] font-black text-muted-foreground uppercase tracking-widest">নতুন কোনো অভিযোগ নেই।</p>
            </div>
          </CardContent>
        </Card>
